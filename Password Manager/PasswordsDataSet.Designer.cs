...
namespace Password_Manager {
    ...
    public partial class PasswordsDataSet : global::System.Data.DataSet {
        ...
        public partial class AccountsDataTable : global::System.Data.TypedTableBase<AccountsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public AccountsRow AddAccountsRow(string Username, string Password, string Name, string Host, string Description, System.DateTime Date) {
        ...
        public partial class AccountsRow : global::System.Data.DataRow {
            ...
            public string Host {
                get {
                    try {
                        return ((string)(this[this.tableAccounts.HostColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("The value for column \'Host\' in table \'Accounts\' is DBNull.", e);
                    }
                }
                set {
                    this[this.tableAccounts.HostColumn] = value;
                }
            }
            ...
            public bool IsHostNull() {
                return this.IsNull(this.tableAccounts.HostColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetHostNull() {
                this[this.tableAccounts.HostColumn] = global::System.Convert.DBNull;
            }
...
namespace Password_Manager.PasswordsDataSetTableAdapters {
    ...
    public partial class AccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Accounts] WHERE (([Username] = @Original_Username) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Host = 1 AND [Host] IS NULL) OR ([Host] = @Original_Host)) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Accounts] ([Username], [Password], [Name], [Host], [Description], [Date]) VALUES (@Username, @Password, @Name, @Host, @Description, @Date);
SELECT Username, Password, Name, Host, Description, Date FROM Accounts WHERE (Username = @Username)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Accounts] SET [Username] = @Username, [Password] = @Password, [Name] = @Name, [Host] = @Host, [Description] = @Description, [Date] = @Date WHERE (([Username] = @Original_Username) AND ((@IsNull_Password = 1 AND [Password] IS NULL) OR ([Password] = @Original_Password)) AND ((@IsNull_Name = 1 AND [Name] IS NULL) OR ([Name] = @Original_Name)) AND ((@IsNull_Host = 1 AND [Host] IS NULL) OR ([Host] = @Original_Host)) AND ((@IsNull_Description = 1 AND [Description] IS NULL) OR ([Description] = @Original_Description)) AND ((@IsNull_Date = 1 AND [Date] IS NULL) OR ([Date] = @Original_Date)));
SELECT Username, Password, Name, Host, Description, Date FROM Accounts WHERE (Username = @Username)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Password_Manager.Properties.Settings.Default.PasswordsConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Username, Password, Name, Host, Description, Date FROM dbo.Accounts";
        ...
        public virtual int Fill(PasswordsDataSet.AccountsDataTable dataTable) {
        ...
        public virtual PasswordsDataSet.AccountsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            PasswordsDataSet.AccountsDataTable dataTable = new PasswordsDataSet.AccountsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(PasswordsDataSet.AccountsDataTable dataTable) {
        ...
        public virtual int Delete(string Original_Username, string Original_Password, string Original_Name, string Original_Host, string Original_Description, global::System.Nullable<global::System.DateTime> Original_Date) {
        ...
        public virtual int Insert(string Username, string Password, string Name, string Host, string Description, global::System.Nullable<global::System.DateTime> Date) {
            if ((Username == null)) {
        ...
        public virtual int Update(string Username, string Password, string Name, string Host, string Description, global::System.Nullable<global::System.DateTime> Date, string Original_Username, string Original_Password, string Original_Name, string Original_Host, string Original_Description, global::System.Nullable<global::System.DateTime> Original_Date) {
            if ((Username == null)) {
                throw new global::System.ArgumentNullException("Username");
            }
            else {
            ...
            if ((Original_Host == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[12].Value = ((string)(Original_Host));
            }
            if ((Original_Description == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string Name, string Host, string Description, global::System.Nullable<global::System.DateTime> Date, string Original_Username, string Original_Password, string Original_Name, string Original_Host, string Original_Description, global::System.Nullable<global::System.DateTime> Original_Date) {
            return this.Update(Original_Username, Password, Name, Host, Description, Date, Original_Username, Original_Password, Original_Name, Original_Host, Original_Description, Original_Date);
        }
    }
